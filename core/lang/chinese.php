...
$lang_global = array(
  // ----- GENERAL ERROR CODES -----
  'err_sql_conn_db' => '无法连接数据库Error - Connection to database is not established!',
  'err_sql_open_db' => '无法打开数据库Error - Can\'t open the database!',
  'err_no_result' => '没有结果!',
  'err_no_user' => '没有用户!',
  'err_no_records_found' => '没有结果!',
  'err_no_search_passed' => '无搜索',
  'err_invalid_input' => '非法输入',
  'err_no_permission' => '你没有权限进入或编辑此栏目数据!',
  // ------ GENERAL -----
  'empty_fields' => '有些字段是空的',
  'search' => '搜索',
  'limit' => '限制',
  'back' => '后退',
  'go_back' => '后退',
...
function lang_login()
{
  ...
  'password' => '密码',
  'not_registrated' => '注册',
  'bad_pass_user' => '用户名或密码不正确!',
  'missing_pass_user' => '请填入用户名和密码!',
  'banned_acc' => '你账户已经被禁用，请联系管理员119422451@qq.com',
  'locked_acc' => '你账户目前在线，如有问题请联系管理员119422451@qq.com',
  'no_permision' => '你没有权限访问次目录!',
  'enter_valid_logon' => '请输入正确的用户名密码!',
  'select_realm' => '选择服务器',
  'remember_me' => '记住我',
  'pass_recovery' => '重置密码',
  'verify_required' => '你的账户需要验证，请登录邮箱完成验证!',
  'after_registration' => '注册成功!',
  'invalid_code' => '发生错误!',
  'security_code' => '安全码'
  );
  return $lang_login;
...
$lang_register = array(
  ...
  'create_acc' => '创建帐户',
  'username' => '用户名',
  'use_eng_chars_limited_len' => '请使用英文字母.<br />最少4位|最长14位.',
  'password' => '密码',
  'confirm_password' => '再次输入密码',
  'min_pass_len' => '最少4位|最长25位..',
  'email' => '电子邮箱',
  'use_valid_mail' => '请输入正确的邮箱格式.',
  'create_acc_button' => '创建账户',
  'diff_pass_entered' => '两次输入的密码必须保持一致.',
  'already_exist' => '账户已经存在',
  'acc_reg_closed' => '非常抱歉，目前暂停注册功能.',
  'wrong_pass_username_size' => '用户名/密码长度必须在4到15个字符之间！',
  'bad_chars_used' => '用户名只能是数字或英文字母!',
  'invalid_email' => '请输入合法的邮箱格式',
  'banned_ip' => '你的IP地址无法进入',
  'contact_serv_admin' => '请联系服务器管理员',
  'users_ip_range' => '用户来自的IP范围',
  'cannot_create_acc' => '不能创建账户',
  'fill_all_fields' => '请填入所有字段',
  'acc_type' => '账户类型',
  'acc_type_desc' => '你使用的客户端类型.',
  'classic' => '最古老的版本',
  'tbc' => '燃烧远征',
  'wotlk' => '巫妖王之怒',
  'recover_acc_password' => '重置密码',
  'user_pass_rec_desc' => '请输入您注册时的用户名.',
  /* The upper lines have been checked, please do not change the language files without notification. */
  'mail_pass_rec_desc' => '请确认输入的是您注册时输入的邮箱.',
  'recover_pass' => '重置密码',
  'user_mail_not_found' => '用户名/邮箱未能找到.',
  'recovery_mail_sent' => '重置邮件已经发出',
  'read_terms' => '在账户创建前请您仔细阅读服务协议并同意',
  'terms' => '服务协议',
  'error_terms' => '您未同意服务协议',
  'i_agree' => '我同意',
  'i_dont_agree' => '我不同意',
  'pass_too_long' => '密码超过最长长度',
  'account_needs_verified' => '账户已经注册，目前正在等待验证!',
  'invited_by' => '邀请至',
  'invited_info' => '请填写邀请您的账户名.',
  'email_address_used' => '邮箱已经注册过.',
  'referrer_not_found' => '用户未找到.',
  );
...
function lang_index()
{
  ...
  (
    'realm' => '服务器',
    'online' => '已正常运行:',
    'offline_or_let_high' => '离线或潜水',
    'add_motd' => '加入日记',
    'delete' => '删除',
    'tot_users_online' => '在线总人数',
    'name' => '名字',
    'race' => '种族',
    'class' => '职业',
    'level' => '等级',
