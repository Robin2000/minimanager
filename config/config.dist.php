...
$server[1]['soap_port']		 = 7878;		// SOAP port
$server[1]['soap_user']		 = 'USER';		// SOAP username, must be all CAPS
$server[1]['soap_pass']		 = 'pass';		// SOAP password
...
$server[2]['soap_port']		 = 7878;		// SOAP port
$server[2]['soap_user']		 = 'USER';		// SOAP username, must be all CAPS
$server[2]['soap_pass']		 = 'pass';		// SOAP password
...
$invited_by             = false;    // true = to activate invite system
...
(
	...
	(				'index.php',		'main', array
		(
			...
			array(	'groups.php',		'groups',		-1,5,5,5),
